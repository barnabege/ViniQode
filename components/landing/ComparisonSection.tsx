      ...
      <div className="container-page py-24 sm:py-28 lg:py-32">
        ...
        <Reveal y={20} delay={0.2}>
          <div className="mt-14 lg:mt-20">
            ...
            {/* Lignes */}
            <ul className="divide-y divide-border lg:divide-y lg:border-t-0">
              {ROWS.map((row) => (
                <li
                  key={row.axis}
                ...
                >
                  ...
                  <div className="lg:order-3 lg:border-l lg:border-border lg:pl-10">
                    <p className="mt-4 text-[11px] font-medium uppercase tracking-[0.25em] text-foreground lg:hidden lg:mt-0">
                      Avec ViniQode
                    </p>
