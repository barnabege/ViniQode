...
import { RenvoyerEmailButton } from "./RenvoyerEmailButton";
...
export function ListeProblemes({ resultat, email }: ListeProblemesProps) {
    ...
    <section id="liste-problemes" className="mt-10 scroll-mt-24">
      ...
      <div className="mt-5 space-y-4">
        {resultat.cuvees_problematiques.map((c) => {
          const seulementEmail =
            c.problemes.length === 1 &&
            c.problemes[0]?.champ === "email_non_confirme";
            ...
            >
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex shrink-0 items-center sm:pt-1">
                  {seulementEmail ? (
                    <RenvoyerEmailButton email={email} />
                  ) : (
                    <Link
